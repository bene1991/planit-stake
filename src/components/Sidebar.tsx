...
import { TrendingUp, Calendar, BarChart3, User as UserIcon, LogOut, CalendarDays } from "lucide-react";
...
export const Sidebar = ({ onItemClick }: SidebarProps = {}) => {
  ...
  const navItems = [
    ...
    { path: "/monthly-report", label: "Fechamento Mensal", icon: CalendarDays },
  ];
